package com.app.gongza.libs.view.tabstrip;
 ...
 * 
  ...
  * @Description: 根据本项目业务仿PagerSlidingTabStrip写的横滚标签
  * @author gongza
  * @date 2015年9月8日 下午4:43:48
  *
 */
public class SlidingTabStrip extends HorizontalScrollView {

	public interface SlidingTabListener {
		public int onSlidingTabListener(int position);
	}
	...
	public SlidingTabListener onSlidingTabListener;
	...
	private int selectedTabTextColor = 0xFFc2195d;
	...
	private int tabBackgroundResId = R.drawable.bg_pagerslidingtabstrip_tab;
	...
	public void setOnSlidingTabListener(SlidingTabListener listener) {
		this.onSlidingTabListener = listener;
	}
	...
	public void showTabClick(int position) {
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (onSlidingTabListener != null) {
					onSlidingTabListener.onSlidingTabListener(position);
				}
			}
		});
	...
	public interface ScrollViewListener {
		void onScrollChanged(SlidingTabStrip scrollView, int x, int y, int oldx, int oldy);  
	}
