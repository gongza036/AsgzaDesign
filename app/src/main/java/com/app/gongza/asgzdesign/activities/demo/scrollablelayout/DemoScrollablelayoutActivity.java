package com.app.gongza.asgzdesign.activities.demo.scrollablelayout;
...
import com.app.gongza.asgzdesign.activities.demo.scrollablelayout.fragment.ParallaxImageHeaderFragment;
import com.app.gongza.asgzdesign.activities.demo.scrollablelayout.fragment.SimpleDemoFragment;

/**
 * https://github.com/jaikydota/Android-ScrollableHeader
 */
public class DemoScrollablelayoutActivity extends FragmentActivity {
    private View scrollView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_demo_scrollablelayout);
