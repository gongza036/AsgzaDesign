...
import com.app.gongza.asgzdesign.activities.demo.scrollablelayout.adapter.MyHeadPicAdapter;
...
public class SimpleDemoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_simple_scrollablelayout, container, false);
