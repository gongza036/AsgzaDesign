package com.app.gongza.asgzdesign.activities.demo.scrollablelayout.adapter;/**
...
import com.app.gongza.asgzdesign.activities.demo.scrollablelayout.constant.ColorsConstant;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.SimpleViewHolder> {
    ...
    public RecyclerAdapter.SimpleViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new SimpleViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_list_scrollablelayout, viewGroup, false));
    }
